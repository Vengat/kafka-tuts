...
public class PosInvoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public com.vengat.tuts.types.DeliveryAddress getDeliveryAddress() {
   ...
   * @param value the value to set.
   */
  public void setDeliveryAddress(com.vengat.tuts.types.DeliveryAddress value) {
   ...
   */
  public java.util.List<com.vengat.tuts.types.LineItem> getInvoiceLineItems() {
   ...
   * @param value the value to set.
   */
  public void setInvoiceLineItems(java.util.List<com.vengat.tuts.types.LineItem> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PosInvoice>
    ...
    private Builder(Builder other) {
      ...
      if (other.hasDeliveryAddressBuilder()) {
        this.DeliveryAddressBuilder = com.vengat.tuts.types.DeliveryAddress.newBuilder(other.getDeliveryAddressBuilder());
      }
     ...
     * @return This builder.
     */
    public com.vengat.tuts.types.DeliveryAddress.Builder getDeliveryAddressBuilder() {
      if (DeliveryAddressBuilder == null) {
        if (hasDeliveryAddress()) {
          setDeliveryAddressBuilder(com.vengat.tuts.types.DeliveryAddress.newBuilder(DeliveryAddress));
        } else {
          setDeliveryAddressBuilder(com.vengat.tuts.types.DeliveryAddress.newBuilder());
        }
      }
    ...
    public PosInvoice build() {
      try {
        ...
        if (DeliveryAddressBuilder != null) {
          ...
          record.DeliveryAddress = fieldSetFlags()[15] ? this.DeliveryAddress : (com.vengat.tuts.types.DeliveryAddress) defaultValue(fields()[15]);
        }
        record.InvoiceLineItems = fieldSetFlags()[16] ? this.InvoiceLineItems : (java.util.List<com.vengat.tuts.types.LineItem>) defaultValue(fields()[16]);
        return record;
      } catch (Exception e) {
